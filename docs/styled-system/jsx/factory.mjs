...
function styledFn(Dynamic, configOrCva = {}, options = {}) {
  ...
  const PandoComponent = /* @__PURE__ */ forwardRef(
    function PandoComponent(props, ref) {
      const {
  ...
  PandoComponent.displayName = `pando.${name}`
  PandoComponent.__cva__ = cvaFn
  PandoComponent.__base__ = Dynamic
  PandoComponent.__shouldForwardProps__ = shouldForwardProp

  return PandoComponent
}
...
export const pando = /* @__PURE__ */ createJsxFactory()
