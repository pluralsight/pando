...
If you are using an SSR app (like <TextLink href="https://nextjs.org/">NextJS</TextLink>) and are unable to use the hook on the client-side, we provide some additional helpers in the react-utils library.
...
1. Make sure you have followed the Pando <TextLink href="/add-pando-to-a-website/react-components-library/step-1/">installation guide</TextLink>.
1. Make sure you are using the correct top level <TextLink href="#usage">theme **and** mode values</TextLink>.
1. Make sure you have a theme defined in your CSS using the Pando guidelines.
