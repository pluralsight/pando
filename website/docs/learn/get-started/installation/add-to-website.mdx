...
Accessibility is our highest priority in Pando, and HTML text elements are naturally accessbile, so we've built our reset around this concept. Use the correct HTML and you will get both styling and Accessibility! :tada:
...
```diff showLineNumbers title="Replace old Buttons with your new Button Component."
