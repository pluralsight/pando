...
describe('neutralTokens', () => {
  ...
  test('should have border 300 colors', () => {
    expect(neutralTokens.neutral.border[300].value._inkyBlueTheme.base).toEqual(
      '#585FA2',
    )
    expect(
      neutralTokens.neutral.border[300].value._inkyBlueTheme._lightMode,
    ).toEqual('#89A4C7')
    expect(
      neutralTokens.neutral.border[300].value._inkyBlueTheme._darkMode,
    ).toEqual('#585FA2')
  })
  ...
  test('should have surface 400 colors', () => {
    expect(
      neutralTokens.neutral.surface[400].value._inkyBlueTheme.base,
    ).toEqual('#2A2753')
    expect(
      neutralTokens.neutral.surface[400].value._inkyBlueTheme._lightMode,
    ).toEqual('#e5e8eb')
    expect(
      neutralTokens.neutral.surface[400].value._inkyBlueTheme._darkMode,
    ).toEqual('#2A2753')
  })
  ...
  test('should have text 400 colors', () => {
    expect(neutralTokens.neutral.text[400].value._inkyBlueTheme.base).toEqual(
      '#F3F3F8',
    )
    expect(
      neutralTokens.neutral.text[400].value._inkyBlueTheme._lightMode,
    ).toEqual('#1A2737')
    expect(
      neutralTokens.neutral.text[400].value._inkyBlueTheme._darkMode,
    ).toEqual('#F3F3F8')
  })
